    ...
    return (
      <div className="indicator">
        <Slider {...settings}>
          <div className="">
            <img
              src={require("../../assets/images/landing/web/react.png")}
              alt="web-1"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/TYPESCRIPT.png")}
              alt="web-2"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/RB.png")}
              alt="web-3"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/NPM.png")}
              alt="web-4"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/YARN.png")}
              alt="web-5"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/SASS.png")}
              alt="web-6"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/CSS.png")}
              alt="web-7"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/MUI.png")}
              alt="web-8"
            />
          ...
          <div className="">
            <img
              src={require("../../assets/images/landing/web/GULP.png")}
              alt="web-9"
            />

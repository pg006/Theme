...
export class TotalUser extends React.Component {
  constructor(props) {
    super(props);
...
export class TotalProfit extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      series: [{
        data: [18, 56, 36, 32, 48, 54, 37, 58, 66, 53, 21, 64, 14, 45, 0, 32, 67, 49, 52, 155, 46, 54, 130],
        color: '#ec82ef',
      }],
      options: {
        chart: {
...
export class TotalExpenses extends React.Component {
  constructor(props) {
    super(props);
...
export class TotalCost extends React.Component {
  constructor(props) {
    super(props);

...
export class SupportCost extends React.Component {
  constructor(props) {
    super(props);
...
export class TotalRequest extends React.Component {
  constructor(props) {
    super(props);
...
export class RequestsAnswered extends React.Component {
  constructor(props) {
    super(props);

                  ...
                  <pre>
                    <code>
                      {`<div className="text-wrap">
                          <p>
                            Any single{" "}
                            <code className="highlighter-rouge">.btn</code> can
                            be turned into Link dropdown toggle with some markup
                            changes.The best part is you can do this with any
                            button variant, too
                          </p>
                          <div className="example">
                            <ButtonGroup className="mt-2 mb-2 me-1">
                ...
                <Collapse in={DropMenu} className="mt-2 max-height-250">
                  <pre>
                    <code>
                      {`<div className="text-wrap">
                          <p>
                            Samples of Dropdown menus Headers, Dividers, Text,
                            Forms{" "}
                          </p>
                          <div className="example">
                            <ButtonGroup className="mt-2 mb-2 me-1">
                            ...
                            <Dropdown className="btn-group mt-2 mb-2 me-1">
                              ...
                              <Dropdown.Menu className="dropdown-menu p-4 text-muted">
                                <p>
                                  ...
                                  the dropdown menu.And this is more example
                                  text.
                                </p>
                              </Dropdown.Menu>
                            </Dropdown>
